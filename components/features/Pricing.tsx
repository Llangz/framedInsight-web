...
const tiers = [
  ...
  },
  {
    ...
    features: [
      'Unlimited records',
      'AI expert advice (dairy, coffee, goats, poultry)',
  ...
  },
  {
    ...
    price: 'Custom',
    period: '',
    description: 'For cooperatives, FCS societies & large farms (50+ member farmers).',
    features: [
      'Everything in Pro',
      'Cooperative officer dashboard',
      'Map & onboard member farmers (no smartphone needed)',
      'Factory-level production aggregation',
      'Bulk EUDR group compliance export',
      'Member claim-code onboarding flow',
      'Quality grading & lot tracking',
      'WhatsApp-based farmer data collection',
